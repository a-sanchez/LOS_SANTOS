    ...
    <div class="swiper-wrapper">
      ...
      <div class="swiper-slide" style="width: 380px !important;">
        <div class="card zoom">
          ...
          <div class="card-body">
            <h5 class="card-title" style="font-family:Avenir Next Condensed;font-weight:bold">{{$joya->nombre}}</h5>
            <p class="card-text" style="font-family:Avenir Next Condensed;">{{number_format($joya->precio,0)}} SANTOS
            </p>
          </div>
        </div>
      </div>
            ...
            <div class="col-md-5">
              ...
              <div class="row">
                <div class="col-md-12 mt-3" style="line-height: 1;">
                  <a style="font-family:Avenir Next Condensed;font-size:25px" id="joya_nombre"></a>
                </div>
                <div class="col-md-12">
                ...
                <div class="col-md-12 mt-2">
                  <a style="font-size:20px;font-family:Avenir Next Condensed;" id="material_joya">
                  </a>
                </div>
              ...
              <div class="row mb-2">
                <label style="font-size:12px;font-family:Avenir Next Condensed;border:none"> Cantidad Disponible:
                  <input id="inventario" name="inventario"
                    style="font-size:12px;font-family:Avenir Next Condensed;border:none">
                </label>
              </div>
            </div>
            <div class="col-md-1"></div>
