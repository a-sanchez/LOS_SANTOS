    ...
    <table class="table" id="ordenes_table" width="100%" style="text-align:center">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <a  style="color: black" href="#"  class="btn"><i style="font-size:1.5rem" id="pen"  class="fas fa-pen"></i></a>
                    <a  style="color: black" href="#"  class="btn"><i style="font-size:1.5rem" id="info-circle"  class="fas fa-info-circle"></i></a>
                    <a  style="color: black"  class="btn"><i style="font-size:1.5rem" id="trash-alt"  class="fas fa-trash-alt"></i></a>
                </td>
            </tr>
            @endforeach
        </tbody>
